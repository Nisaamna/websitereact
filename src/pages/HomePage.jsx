      ...
      <Container> 
        <Row className="header-box d-flex align-items-center pt-lg-5">
          <Col lg="6">
            ...
            <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius nisi, molestiae sed aliquam ex animi.</p>
          ...
          {kelasTerbaru.map((kelas) => {
            return (
              ...
              data-aos-delay={kelas.delay}>
               <img src={kelas.image} alt="unslapsh.com"className="w-100 mb-5 rounded-top" />
